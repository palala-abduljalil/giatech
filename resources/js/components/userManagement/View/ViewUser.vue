                ...
                <div class="col-lg-4 col-xl-4">
                    <div class="card-box text-center">
                        ...
                        <div class="mt-3 text-left">
                            ...
                            <span class="text-muted font-weight-bold">
                                <i class="fas fa-id-badge mr-1"></i> Employee ID
                            </span>
                            <p class="text-muted font-13">
                ...
                <div class="col-lg-8 col-xl-8">
                    <div class="card-box">
                        ...
                        <div class="tab-content">
                            ...
                            >
                                <view-user-information :data="user"/>
                            </div>
                            <div class="tab-pane" id="security-questions">
                                <view-user-security-questions :user-id="userId"/>
                            </div>
                            <div class="tab-pane" id="activity-logs">
                                <view-user-activity-logs :user-id="userId"/>
                            </div>
                        </div>
                    </div>
                </div>
...
import ViewUserSecurityQuestions from "./ViewSecurityQuestions/ViewSecurityQuestions";
import ViewUserActivityLogs from "./ViewActivityLogs/ViewActivityLogs";
