<template>
    <div id="serviceDescription" class="card">
            ...
            <form data-vv-scope="form1">
                <div class="form-group">
                    <text-area
                        ...
                        errorMessage="form1.serviceDescription"
                        errorLabel="Service Description"
                    />
                </div>
            </form>
        </div>
...
export default {
        ...
        update() {
            this.$validator.validateAll("form1").then((valid) => {
                if (valid) {
                    ...
                    axios
                        .put(`/api/company/service/${companyID}/service-description`, this.form)
                        .then((response) => {
                            Toast.fire({
                                icon: "success",
    ...
    mounted() {
        this.form.serviceDescription = this.text;
    },
};
</script>
