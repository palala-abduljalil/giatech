...
export default {
    ...
    methods: {
        ...
        addAttachments(files) {
            ...
            axios
                .post(`/api/employee/${this.employeeId}/attachment`, files, config)
                .then((response) => {
                    this.getAttachments();
                    Toast.fire({
                        icon: "success",
        ...
        removeAttachment(item) {
            this.showLoader = true;
            axios
                .delete(`/api/employee/${this.employeeId}/attachment/${item.uuid}`)
                .then(() => {
                    this.getAttachments();
                    Toast.fire({
                        icon: "success",
        ...
        getAttachments() {
            axios
                .get(`/api/employee/${this.employeeId}/attachment`)
                .then((response) => {
