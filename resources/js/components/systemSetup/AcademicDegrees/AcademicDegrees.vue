    ...
    <div v-if="isPageLoad">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <academic-degree-list :items="list"
...
import AcademicDegreesHeader from "./AcademicDegreesHeader";
...
export default {
    components: {
        Loader,
        AcademicDegreeList,
        AcademicDegreesHeader,
        Modal,
    },
    data() {
        return {
            TITLE: 'Academic Degree',
            MODAL_ID: '#academicDegreeModal',
            AXIOS_URL: 'api/degree',
            isPageLoad: false,
            method: "",
            modalTitle: "",
            submitButton: "",
