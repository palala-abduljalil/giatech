...
export default {
    ...
    methods: {
        ...
        addAttachments(files) {
            ...
            axios
                .post(`/api/project/${this.projectId}/attachment`, files, config)
                .then((response) => {
                    this.getAttachments();
                    Toast.fire({
                        icon: "success",
        ...
        removeAttachment(item) {
            this.showLoader = true;
            axios
                .delete(`/api/project/${this.projectId}/attachment/${item.uuid}`)
                .then(() => {
                    this.getAttachments();
                    Toast.fire({
                        icon: "success",
        ...
        getAttachments() {
            axios
                .get(`/api/project/${this.projectId}/attachment`)
                .then((response) => {
